...
const CourseTab = () => {
    ...
    const getCourseById = async () => {
      try {
         const res = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/v1/course/${id}`, 
         ...
         console.error(error, "getCourseById handler error")
      }
    }
    ...
    const updateCourseHandler = async () => {
      ...
      try {
        setLoading(true);
         const res = await axios.put(`${import.meta.env.VITE_BACKEND_URL}/api/v1/course/${id}`, formData, {
          headers: {
    ...
    const togglePublishUnpublish = async(action) => {
      try {
        const res = await axios.patch(`${import.meta.env.VITE_BACKEND_URL}/api/v1/course/${id}`, 
        {},
        {
          params: {
            action
